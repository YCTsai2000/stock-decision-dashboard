...
if (!text.includes('decisionRiskFactor(decision)')) throw new Error('decisionRiskFactor import/use missing');
if (!text.includes('executionRiskFactor * decision.phaseFactor')) throw new Error('phaseFactor patch did not apply');

await fs.writeFile(path, text);
console.log('Applied V6.2 execution risk patch with phase factor');
